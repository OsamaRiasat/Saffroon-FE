...
export default{
    ...
    methods: {
        ...
        RMQCNo() {
            ...
            const resp = http.get(Endpoint + "PMQCNo/",{ 'headers': { 'Authorization': "Token"+" "+sessionStorage.getItem("token") } });
            console.log(resp);
            return resp;
        ...
        RMQCNoSample(QCNo) {
            ...
            const resp = http.get(Endpoint + "PMQCNoSample/"+QCNo+"/");
            console.log(resp);
            return resp;
        ...
        PostRMAnalysis(obj) {
            ...
            const resp = http.post(Endpoint + "PostPMAnalysis/", obj);
            console.log(resp);
            return resp;
