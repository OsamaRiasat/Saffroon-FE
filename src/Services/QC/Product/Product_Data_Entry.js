...
export default{
    ...
    methods: {
        ...
        RMQCNo() {
            ...
            const resp = http.get(Endpoint + "ProductQCNo/",{ 'headers': { 'Authorization': "Token"+" "+sessionStorage.getItem("token") } });
            console.log(resp);
            return resp;
        ...
        RMQCNoSample(QCNo) {
            ...
            const resp = http.get(Endpoint + "ProductQCNoSample/"+QCNo+"/");
            console.log(resp);
            return resp;
        ...
        PostRMAnalysis(obj) {
            ...
            const resp = http.post(Endpoint + "PostProductAnalysis/", obj);
            console.log(resp);
            return resp;
