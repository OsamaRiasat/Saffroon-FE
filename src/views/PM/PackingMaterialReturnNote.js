...
import { GRNoList, RMRecievingDetailByGRNo, RM_Returned } from '../../Services/Inventory/PM/PM_Material_Return_Note.js';
export default class PakingMaterialReturnNote extends Component{
    ...
    render() {
        ...
        return (
                ...
                <GridItem xs={12} sm={12} md={12}>
                    <Card>
                        <CardHeader color="primary">
                            <h2 >Packinng Material Destrtuction Note </h2>
                        </CardHeader>
                        <CardBody>
          ...
          <div id="hide">
            ...
            <h2>Material Destrtuction Note</h2>
