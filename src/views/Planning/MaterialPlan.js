...
export default class MaterialPlan extends Component {
  ...
  handleCalculateMaterials = async () => {
    const data = await PlanMaterialCalculation(
      this.props.planno,
      this.state.includeQuarantine,
      this.state.includePIP
    );
                      ...
                      <GridContainer>
                        ...
                        <GridItem xs={12} sm={12} md={7}>
                          ...
                          <Button
                            ...
                            disabled={!this.state.onceClicked}
                            color="primary"
                          >
                            GoTo Production Plan
                          </Button>
                        </GridItem>
                      </GridContainer>
                    </CardContent>
                    ...
                    <CardBody>
                      <GridContainer>
                        <div style={{ height: 450, width: "100%" }}>
                          <DataGrid rows={products_array} columns={columns} />
                        </div>
                      </GridContainer>
                    </CardBody>
                  </Card>
