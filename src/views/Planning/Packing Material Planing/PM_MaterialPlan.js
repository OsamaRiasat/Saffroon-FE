...
import {
    PlanPackingMaterialCalculation
...
export default class MaterialPlan extends Component {
    ...
    handleCalculateMaterials=async ()=>{
        const data = (await PlanPackingMaterialCalculation(this.props.planno, this.state.includeQuarantine, this.state.includePIP));
                ...
                <GridItem xs={12} sm={12} md={12}>
                    <Card>
                        <CardHeader color="primary">
                            <h2 >B- Packing Material Plan No {this.props.planno} </h2>
                        </CardHeader>
                        <CardBody>
                            <GridContainer>
