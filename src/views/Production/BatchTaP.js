...
export default class BatchTaP extends Component {
    ...
    async handleCode(cod) {
        ...
        this.setState({listOfStages: res['ListOfStages'],T_yield:res.batchSize,
        A_yield:res.batchSize,},()=>{this.handleYields()});
    ...
    handleClearForm=()=>{
        ...
        this.setState({listOfStages:[],T_yield:"",
        A_yield:"",});
        this.setState({cart2:[],cart1:[], data: '',
    ...
    render() {
        ...
        for (let i = 0; i < this.state.cart2.length; ++i) {
                ...
                per_yield: (parseInt(this.state.cart2[i].actualYield)/parseInt(this.state.cart2[i].theoreticalYield)).toFixed(2),
            };
        ...
        const products_array = this.state.batch_selected === true ? products_array2 : products_array1;
                ...
                <GridContainer md={12}>
                    <Card>
                        <CardHeader color="primary">
                            <h2 style={{ textAlign: "center" }}>Batch Tracking and Posting</h2>
                        </CardHeader>
                        <CardBody>
                            <GridContainer>
                                ...
                                <CardContent>
                                    ...
                                    <CardContent>
                                        ...
                                        <GridContainer>
                                            <GridItem xs={12} sm={12} md={2}>
                                                <TextField id="date" fullWidth="true" InputProps={{ readOnly: true, }} value={date} variant="outlined" label="Date: "
                                                />
                                            </GridItem>
                                            ...
                                            <GridItem xs={12} sm={12} md={4}>
                                                <TextField
                                                    ...
                                                    onChange={(event) => {
                                                        this.setState({production_code: event.target.value})
                                                        this.handlePCode(event.target.value);
                                                    }}
                                                >
                                                    {this.state.production_code_list.map((pc) => (
                                                        <MenuItem key={pc["ProductCode"]} value={pc["ProductCode"]}>
                                                            {pc["ProductCode"]}
                                                        </MenuItem>
                                                    ))}
                                                </TextField>
                                        ...
                                        <GridContainer>
                                            <GridItem xs={12} sm={12} md={2}>
                                                <TextField id="batchno" fullWidth="true" select variant="outlined" label={"Batch No: "} value={this.state.selected.batch_no}
                                                onChange={(event)=>{
                                                    this.setState(prevState => ({
                                                        selected: {                   // object that we want to update
                                                            ...prevState.selected,    // keep all other key-value pairs
                                    ...
                                    <CardContent>
                                        <GridContainer>
                                            <GridItem xs={12} sm={12} md={3}>
                                                <TextField id="" fullWidth="true" select variant="outlined" label={"UOM: "} select value={this.state.uom}
                                                onChange={(event)=>{
                                            ...
                                            <GridItem xs={12} sm={12} md={3}>
                                                <TextField
                                                    ...
                                                    onChange={(event)=>{
                                                        this.setState({T_yield: event.target.value}, ()=>{this.handleYields()})
                                                    }}
                                                />
                                            </GridItem>
                                            ...
                                            <GridItem xs={12} sm={12} md={3}>
                                                <TextField
                                                    ...
                                                    onChange={(event)=>{
                                                        this.setState({A_yield: event.target.value}, ()=>{this.handleYields()})
                                                    }}
                                                />
                                            </GridItem>
                                    ...
                                    <CardHeader color="success" style={{
                                        padding: "5px",
                                        marginTop: "10px",
                                        paddingLeft: "20px",
                                    }}>
                                    ...
                                    <CardContent>
                                        ...
                                        <GridContainer>
                                            <GridItem xs={12} sm={12} md={5}>
                                                <TextField id="" fullWidth="true" variant="outlined" label={"Stage:"} select value={this.state.stage}
                                                    onChange={(event)=>{
                                            ...
                                            <GridItem xs={12} sm={12} md={5}>
                                                <TextField id="" fullWidth="true" variant="outlined" label={"Result"} select value={this.state.result}
                                                />
                                            </GridItem>
                                            ...
                                            <GridItem xs={12} sm={12} md={2}>
                                                <Button
                                                    ...
                                                    onClick={()=>{
                                                        if(this.state.selected.batch_no == '' ||
                                                        ...
                                                        this.state.remarks == ''
                                                            ...
                                                            alert("Some data is missing. Complete that first!")
                                                        }
                                                        else {
                                                            this.handlePost();
                                                        }
