...
import Pendings from "../../../Services/QC/PM/PM_Analyst_Pending_Samples.js"
    ...
    render() {
        ...
        for (let i = 0; i < this.state.pendings.length; ++i) {
            let temp = {
              ...
              materialname: this.state.pendings[i].Material,
                ...
                <GridContainer md={12}>
                    <Card>
                        <CardHeader color="primary">
                            <h4 style={{textAlign:"center"}}> PM Pending Reports </h4>
                        </CardHeader>
                        <CardBody>
                            <GridContainer>
