...
import RMSamples from "../../../Services/QC/Product/Product_Sample_Assignment.js";
  ...
  render() {
    ...
    for (let i = 0; i < this.state.samples.length; ++i) {
      let temp = {
        ...
        material: this.state.samples[i].Product,
        qtyunit:
        ...
        stage:this.state.samples[i].stage,
      };
    ...
    for (let i = 0; i < this.state.assignedSamples.length; ++i) {
      let temp = {
        ...
        material: this.state.assignedSamples[i].Product,
        status: this.state.assignedSamples[i].status,
        stage:this.state.assignedSamples[i].stage
      };
        ...
        <GridContainer md={12}>
          <Card>
            <CardHeader color="primary">
              <h2 >Sample Assignment Product </h2>
